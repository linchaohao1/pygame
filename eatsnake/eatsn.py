...
def main():
    ...
    pygame.init()
    SnakespeedCLOCK = pygame.time.Clock()  #pygame.time.Clock()创建pygame.time.Clock对象
    DISPLAYSURF = pygame.display.set_mode((Window_Width, Window_Height))  #即：创建窗口的宽和高，单位是像素
